          ...
          <div class="p-4 space-y-6">
            ...
            <div class="space-y-2">
              ...
              <div class="h-32 flex items-end gap-2">
                <div
                  v-for="(height, day) in hoursSpent"
                  :key="day"
                  class="flex-1 bg-orange-100 rounded-t-lg relative"
                  :style="{ height: `${height}%` }"
                >
                  <div
                    class="absolute inset-x-0 bottom-0 bg-orange-500 rounded-t-lg"
                    :style="{ height: `${height}%` }"
                  ></div>
                </div>
              </div>
...
export default {
  data() {
    return {
      ...
      todoList: [
        { name: "HTML and Interactive Design", completed: false },
        { name: "Introduction to Figma", completed: true },
        { name: "UI/UX Design Course", completed: false },
      ],
    };
  },
};
